<template>
  <el-tabs :value="String($store.state.project.currentProjectStatus)" @tab-click="handleClick" class="order-tabs">
...
<script>
import { SET_LOADING, SET_CURRENT_PROJECT_STATUS } from '@/store/mutation-types'
...
export default {
  methods: {
    ...mapMutations({
      ...
      setStatus: SET_CURRENT_PROJECT_STATUS
    }),
